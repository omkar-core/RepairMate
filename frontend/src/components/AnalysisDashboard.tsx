...
import {
  CheckCircle, Clock, Activity, Target, Share2, Cpu, DollarSign, Leaf, BookOpen, Check, Recycle, Download, ChevronRight, AlertOctagon, Cloud, ShieldAlert, AlertTriangle, UserCog, Lightbulb, Wrench
} from 'lucide-react';
            ...
            <div className="w-full md:w-1/3 shrink-0 relative group">
              ...
              <div className="relative z-10 rounded-2xl overflow-hidden border border-white/20 shadow-2xl">
                ...
                >
                  {analysis.componentsDetected?.map((comp, idx) => (
                    <g key={idx}>
                      <rect
                        x={comp.box_2d[1]}
                        y={comp.box_2d[0]}
                        width={comp.box_2d[3] - comp.box_2d[1]}
                        height={comp.box_2d[2] - comp.box_2d[0]}
                        fill="transparent"
                        stroke="#22d3ee"
                        strokeWidth="10"
                  ...
                  {analysis.possibleIssues?.map((issue, idx) => issue.box_2d && (
                    <rect
                      key={`issue-${idx}`}
                      x={issue.box_2d[1]}
                      y={issue.box_2d[0]}
                      width={issue.box_2d[3] - issue.box_2d[1]}
                      height={issue.box_2d[2] - issue.box_2d[0]}
        ...
        <div className="flex flex-col gap-6">
          <motion.div variants={itemVariants} className="bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-3xl p-6 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-bold text-white">Required Tools</h3>
            </div>
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2 bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 shadow-lg">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-bold text-white">Repair Protocol</h3>
            </div>
